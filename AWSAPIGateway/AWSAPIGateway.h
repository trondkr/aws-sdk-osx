...
/*!
 Project version number for the AWSAPIGateway framework.
 ...
 patch-level versioning, you should use AWSAPIGatewaySDKVersion instead.
 @deprecated Use AWSAPIGatewaySDKVersion instead.
 */
FOUNDATION_EXPORT double AWSAPIGatewayVersionNumber DEPRECATED_MSG_ATTRIBUTE("Use AWSAPIGatewaySDKVersion instead.");

/*!
 Project version string for the AWSAPIGateway framework.
