...
/**
 ...
 @see AWSKMSGenerateDataKeyPairResponse
 */
- (void)generateDataKeyPair:(AWSKMSGenerateDataKeyPairRequest *)request completionHandler:(void (^ _Nullable)(AWSKMSGenerateDataKeyPairResponse * _Nullable response, NSError * _Nullable error))completionHandler;
...
/**
 ...
 @see AWSKMSGenerateDataKeyPairWithoutPlaintextResponse
 */
- (void)generateDataKeyPairWithoutPlaintext:(AWSKMSGenerateDataKeyPairWithoutPlaintextRequest *)request completionHandler:(void (^ _Nullable)(AWSKMSGenerateDataKeyPairWithoutPlaintextResponse * _Nullable response, NSError * _Nullable error))completionHandler;
...
/**
 ...
 @param request A container for the necessary parameters to execute the GetPublicKey service method.

 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSKMSGetPublicKeyResponse`. On failed execution, `task.error` may contain an `NSError` with `AWSKMSErrorDomain` domain and the following error code: `AWSKMSErrorNotFound`, `AWSKMSErrorDisabled`, `AWSKMSErrorKeyUnavailable`, `AWSKMSErrorDependencyTimeout`, `AWSKMSErrorUnsupportedOperation`, `AWSKMSErrorInvalidArn`, `AWSKMSErrorInvalidGrantToken`, `AWSKMSErrorInvalidKeyUsage`, `AWSKMSErrorKMSInternal`, `AWSKMSErrorKMSInvalidState`.
 
 @see AWSKMSGetPublicKeyRequest
 @see AWSKMSGetPublicKeyResponse
 */
...
/**
 ...
 @see AWSKMSGetPublicKeyResponse
 */
- (void)getPublicKey:(AWSKMSGetPublicKeyRequest *)request completionHandler:(void (^ _Nullable)(AWSKMSGetPublicKeyResponse * _Nullable response, NSError * _Nullable error))completionHandler;
...
/**
 ...
 @see AWSKMSSignResponse
 */
- (void)sign:(AWSKMSSignRequest *)request completionHandler:(void (^ _Nullable)(AWSKMSSignResponse * _Nullable response, NSError * _Nullable error))completionHandler;
...
/**
 ...
 @see AWSKMSVerifyResponse
 */
- (void)verify:(AWSKMSVerifyRequest *)request completionHandler:(void (^ _Nullable)(AWSKMSVerifyResponse * _Nullable response, NSError * _Nullable error))completionHandler;
