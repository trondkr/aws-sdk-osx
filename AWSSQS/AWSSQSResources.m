...
- (NSString *)definitionString {
  ...
  \"operations\":{\
    ...
    \"ListDeadLetterSourceQueues\":{\
      ...
      \"documentation\":\"<p>Returns a list of your queues that have the <code>RedrivePolicy</code> queue attribute configured with a dead-letter queue.</p> <p>For more information about using dead-letter queues, see <a href=\\\"http://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-dead-letter-queues.html\\\">Using Amazon SQS Dead-Letter Queues</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p>\"\
    },\
    \"ListQueueTags\":{\
      \"name\":\"ListQueueTags\",\
      \"http\":{\
    ...
    \"ListQueues\":{\
      ...
      \"documentation\":\"<p>Returns a list of your queues. The maximum number of queues that can be returned is 1,000. If you specify a value for the optional <code>QueueNamePrefix</code> parameter, only queues with a name that begins with the specified value are returned.</p> <note> <p>Cross-account permissions don't apply to this action. For more information, see see <a href=\\\"http://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-customer-managed-policy-examples.html#grant-cross-account-permissions-to-role-and-user-name\\\">Grant Cross-Account Permissions to a Role and a User Name</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p> </note>\"\
    },\
    \"PurgeQueue\":{\
      \"name\":\"PurgeQueue\",\
      \"http\":{\
    ...
    \"TagQueue\":{\
      ...
      \"documentation\":\"<p>Add cost allocation tags to the specified Amazon SQS queue. For an overview, see <a href=\\\"http://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-queue-tags.html\\\">Tagging Your Amazon SQS Queues</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p> <p>When you use queue tags, keep the following guidelines in mind:</p> <ul> <li> <p>Adding more than 50 tags to a queue isn't recommended.</p> </li> <li> <p>Tags don't have any semantic meaning. Amazon SQS interprets tags as character strings.</p> </li> <li> <p>Tags are case-sensitive.</p> </li> <li> <p>A new tag with a key identical to that of an existing tag overwrites the existing tag.</p> </li> <li> <p>Tagging actions are limited to 5 TPS per AWS account. If your application requires a higher throughput, file a <a href=\\\"https://console.aws.amazon.com/support/home#/case/create?issueType=technical\\\">technical support request</a>.</p> </li> </ul> <p>For a full list of tag restrictions, see <a href=\\\"http://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-limits.html#limits-queues\\\">Limits Related to Queues</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p> <note> <p>Cross-account permissions don't apply to this action. For more information, see see <a href=\\\"http://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-customer-managed-policy-examples.html#grant-cross-account-permissions-to-role-and-user-name\\\">Grant Cross-Account Permissions to a Role and a User Name</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p> </note>\"\
    },\
    \"UntagQueue\":{\
      \"name\":\"UntagQueue\",\
      \"http\":{\
      ...
      \"documentation\":\"<p>Remove cost allocation tags from the specified Amazon SQS queue. For an overview, see <a href=\\\"http://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-queue-tags.html\\\">Tagging Your Amazon SQS Queues</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p> <p>When you use queue tags, keep the following guidelines in mind:</p> <ul> <li> <p>Adding more than 50 tags to a queue isn't recommended.</p> </li> <li> <p>Tags don't have any semantic meaning. Amazon SQS interprets tags as character strings.</p> </li> <li> <p>Tags are case-sensitive.</p> </li> <li> <p>A new tag with a key identical to that of an existing tag overwrites the existing tag.</p> </li> <li> <p>Tagging actions are limited to 5 TPS per AWS account. If your application requires a higher throughput, file a <a href=\\\"https://console.aws.amazon.com/support/home#/case/create?issueType=technical\\\">technical support request</a>.</p> </li> </ul> <p>For a full list of tag restrictions, see <a href=\\\"http://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-limits.html#limits-queues\\\">Limits Related to Queues</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p> <note> <p>Cross-account permissions don't apply to this action. For more information, see see <a href=\\\"http://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-customer-managed-policy-examples.html#grant-cross-account-permissions-to-role-and-user-name\\\">Grant Cross-Account Permissions to a Role and a User Name</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p> </note>\"\
    }\
  },\
  \"shapes\":{\
    \"AWSAccountIdList\":{\
    ...
    \"BatchResultErrorEntry\":{\
      ...
      \"members\":{\
        ...
        \"SenderFault\":{\
          \"shape\":\"Boolean\",\
          \"documentation\":\"<p>Specifies whether the error happened due to the producer.</p>\"\
        },\
        \"Code\":{\
          \"shape\":\"String\",\
    ...
    \"ChangeMessageVisibilityBatchRequestEntry\":{\
      ...
      \"members\":{\
        \"Id\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>An identifier for this particular receipt handle used to communicate the result.</p> <note> <p>The <code>Id</code>s of a batch request need to be unique within a request</p> </note>\"\
        },\
        \"ReceiptHandle\":{\
          \"shape\":\"String\",\
    ...
    \"ChangeMessageVisibilityRequest\":{\
      ...
      \"members\":{\
        ...
        \"VisibilityTimeout\":{\
          \"shape\":\"Integer\",\
          \"documentation\":\"<p>The new value for the message's visibility timeout (in seconds). Values values: <code>0</code> to <code>43200</code>. Maximum: 12 hours.</p>\"\
        }\
      }\
    },\
    \"CreateQueueRequest\":{\
    ...
    \"DeleteMessageBatchRequestEntry\":{\
      ...
      \"members\":{\
        \"Id\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>An identifier for this particular receipt handle. This is used to communicate the result.</p> <note> <p>The <code>Id</code>s of a batch request need to be unique within a request</p> </note>\"\
        },\
        \"ReceiptHandle\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>A receipt handle.</p>\"\
    ...
    \"GetQueueUrlResult\":{\
      ...
      \"documentation\":\"<p>For more information, see <a href=\\\"http://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-api-responses.html\\\">Interpreting Responses</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p>\"\
    },\
    ...
    \"InvalidAttributeName\":{\
      ...
      \"documentation\":\"<p>The specified attribute doesn't exist.</p>\",\
      \"exception\":true\
    },\
    \"InvalidBatchEntryId\":{\
      \"type\":\"structure\",\
    ...
    \"ListQueuesResult\":{\
      ...
      \"members\":{\
        \"QueueUrls\":{\
          \"shape\":\"QueueUrlList\",\
          \"documentation\":\"<p>A list of queue URLs, up to 1,000 entries.</p>\"\
        }\
      },\
    ...
    \"OverLimit\":{\
      ...
      \"documentation\":\"<p>The specified action violates a limit. For example, <code>ReceiveMessage</code> returns this error if the maximum number of inflight messages is reached and <code>AddPermission</code> returns this error if the maximum number of permissions for the queue is reached.</p>\",\
      \"error\":{\
        \"code\":\"OverLimit\",\
        \"httpStatusCode\":403,\
        \"senderFault\":true\
    ...
    \"QueueDeletedRecently\":{\
      ...
      \"documentation\":\"<p>You must wait 60 seconds after deleting a queue before you can create another queue with the same name.</p>\",\
      \"error\":{\
    ...
    \"QueueDoesNotExist\":{\
      ...
      \"documentation\":\"<p>The specified queue doesn't exist.</p>\",\
      \"error\":{\
    ...
    \"QueueNameExists\":{\
      ...
      \"documentation\":\"<p>A queue with this name already exists. Amazon SQS returns this error only if the request includes attributes whose values differ from those of the existing queue.</p>\",\
      \"error\":{\
    ...
    \"ReceiptHandleIsInvalid\":{\
      ...
      \"documentation\":\"<p>The specified receipt handle isn't valid.</p>\",\
      \"exception\":true\
    },\
    ...
    \"SendMessageRequest\":{\
      ...
      \"members\":{\
        ...
        \"MessageBody\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The message to send. The maximum string size is 256 KB.</p> <important> <p>A message can include only XML, JSON, and unformatted text. The following Unicode characters are allowed:</p> <p> <code>#x9</code> | <code>#xA</code> | <code>#xD</code> | <code>#x20</code> to <code>#xD7FF</code> | <code>#xE000</code> to <code>#xFFFD</code> | <code>#x10000</code> to <code>#x10FFFF</code> </p> <p>Any characters not included in this list will be rejected. For more information, see the <a href=\\\"http://www.w3.org/TR/REC-xml/#charsets\\\">W3C specification for characters</a>.</p> </important>\"\
        },\
        \"DelaySeconds\":{\
          \"shape\":\"Integer\",\
    ...
    \"SendMessageResult\":{\
      ...
      \"members\":{\
        ...
        \"MessageId\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>An attribute containing the <code>MessageId</code> of the message sent to the queue. For more information, see <a href=\\\"http://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-queue-message-identifiers.html\\\">Queue and Message Identifiers</a> in the <i>Amazon Simple Queue Service Developer Guide</i>. </p>\"\
        },\
        \"SequenceNumber\":{\
          \"shape\":\"String\",\
